...
<!--                        <td class="py-3 px-4 text-center">--><?php //= htmlspecialchars() ?><!--</td>-->
                        <td class="py-3 px-4 flex justify-center space-x-2">
                            ...
                            <a href="volunteer_delete.php?id=<?= $benevole['id'] ?>" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette collecte ?');"
